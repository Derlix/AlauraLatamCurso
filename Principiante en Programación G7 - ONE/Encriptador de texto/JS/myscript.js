...
function encriptar() {
    let v_textoAEncriptar = document.getElementById('encriptarInput').value.trim(); // Obtener el valor y eliminar espacios en blanco al inicio y al final
    ...
    if (tieneTildes || tieneMayusculas) {
        ...
        if (tieneVocales) {
            ...
            asignarTexto('desencriptarInput', mensajeEncriptado);
...
function desEncriptar() {
    ...
    if (tieneTildes || tieneMayusculas) {
        ...
        if (tieneVocales) {
            ...
            asignarTexto('desencriptarInput', mensajeDesEncriptado);
        }
        asignarTexto('indicaciones', 'Palabra o mensaje encriptado');
        asignarTexto('ningun', '');
